...
const BasicTextFields = () => {
  ...
  return (
    <ThemeProvider theme={customtheme}>
        ...
        <Container sx={{ mt: 4, mb: 4 }}>
          ...
          >
            <Typography
              maxWidth="sm"
              variant="h4"
              style={{ textAlign: "center", color: "#fafafa", fontWeight: 600 }}
              sx={{ mb: 2 }}
            >
            ...
            <Typography
              maxWidth="sm"
              variant="subtitle1"
              style={{ textAlign: "center", color: "#fafafa", fontWeight: 400 }}
              sx={{ mb: 3 }}
            >
      ...
      <Box ref={myRef} id="quote_cards" sx={{ pt: 6, pb: 4, display: "none" }}>
        <Container id="quote_data" maxWidth="md">
          <Typography
            variant="subtitle1"
